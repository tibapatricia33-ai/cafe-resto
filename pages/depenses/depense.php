...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($action === "ajouter") {
        ...
        UTILISATEUR
        -------------------------------------------------
        On récupère le premier utilisateur disponible.
        -------------------------------------------------
        */
        ...
        */
        ...
        $sql = "INSERT INTO depense
                (description, quantite, unite, montant, date, id_utilisateur)
                VALUES (?, ?, ?, ?, ?, ?)";
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            name="description"
                            class="form-control"
                            placeholder="Exemple : Achat de sacs de riz"
                            required>
            ...
            <form
                ...
                <div class="modal-body">
                    ...
                    <input
                        ...
                        name="id_depense"
                        value="<?php
                        echo $depenseModification['id_depense'];
                        ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            value="<?php
                            echo htmlspecialchars(
                                $depenseModification['description']
                            );
                            ?>"
                            >
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            min="1"
                            value="<?php
                            echo $depenseModification['quantite'];
                            ?>"
                            >
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            min="1"
                            value="<?php
                            echo $depenseModification['montant'];
                            ?>"
                           >
